...
# are on one line each tagged with a variable emoji (not a fixed scale —
# we don't know what 🎯 vs 👑 vs 🔥 mean, so we just store and reproduce
# whichever emoji was posted). The final score isn't a plain sum of the
